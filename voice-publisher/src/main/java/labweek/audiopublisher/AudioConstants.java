...
public class AudioConstants {
    ...
    static Consumer<Subscription> subscriberLoop(FragmentHandler fragmentHandler, int limit, AtomicBoolean running) {
    ...
    static Consumer<Subscription> subscriberLoop(FragmentHandler fragmentHandler, int limit, AtomicBoolean running, IdleStrategy idleStrategy) {
        return (subscription) -> {
            while(true) {
                try {
                    if (running.get()) {
